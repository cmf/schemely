...
import org.jetbrains.plugins.scheme.psi.api.synthetic.ClSyntheticMethod;
import org.jetbrains.plugins.scheme.psi.api.synthetic.ClSyntheticClass;
...
public class ClSynteticMethodImpl extends LightElement implements ClSyntheticMethod
{
  ...
  Logger
    LOG =
    Logger.getInstance("org.jetbrains.plugins.scheme.psi.impl.synthetic.ClSynteticMethodImpl");
  ...
  {
    super(def.getManager(), SchemeFileType.SCHEME_LANGUAGE);
    myDef = def;
    myClass = clazz;
  ...
  {
    return "SchemeSyntheticMethod[" + getName() + "]";
  }
